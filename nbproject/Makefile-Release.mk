...
${OBJECTDIR}/src/my_console.o: src/my_console.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/my_console.o src/my_console.cpp

${OBJECTDIR}/src/my_serial.o: src/my_serial.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/my_serial.o src/my_serial.cpp

${OBJECTDIR}/src/my_stream.o: src/my_stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/my_stream.o src/my_stream.cpp

${OBJECTDIR}/src/sketch.ino.o: src/sketch.ino.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sketch.ino.o src/sketch.ino.cpp
